...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['auto.check-role:0']], function () {
    ...
    Route::group(['middleware' => ['auto.check-role:1']], function () {
        Route::resource('tintuc', TintucController::class);
        Route::post('/duyet/{id}', [TintucController::class, 'duyet']);
    });

    Route::group(['middleware' => ['auto.check-role:2']], function () {
        Route::resource('tintuc', TintucController::class);
    });

    Route::group(['middleware' => ['auto.check-role:3']], function () {
        Route::resource('user', UserController::class);
    });
});
