<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/home') }}" class="brand-link">
        <img src="{{ url('/frontend') }}/img/pngtree-green-gradient-sports-background-image_582399.jpg"
            alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">SPORT NEWS</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                @if (auth()->user()->hasRole('Chủ biên') |
                    auth()->user()->hasRole('Người duyệt bài') |
                    auth()->user()->hasRole('Người viết bài'))
                    <li class="nav-item">
