        ...
        <div class="container">
            <div class="float--left float--xs-none text-xs-center">
                ...
                <ul class="header--topbar-info nav">
                    ...
                    <li><i class="fa fm fa-mixcloud"></i>29<sup>0</sup> C</li>
            ...
            <div class="float--right float--xs-none text-xs-center">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                    document.getElementById('logout-form').submit();" style="color:red">Đăng xuất</a>
                                </li>
                                <li><a href="{{ route('home') }}" style="color:red">Home</a></li>
                ...
                <ul class="header--topbar-social nav hidden-sm hidden-xxs">
                    ...
                    <li><a href="https://www.youtube.com/channel/UCk8UM8PAAV6PTn3eNuMthRQ"><i
            ...
            <div class="header--logo float--left float--sm-none text-sm-center">
                <h1 class="h1">
                    <a href="{{ url('/') }}" class="btn-link">
                        <img src="/frontend/img/Logo_Sport.svg.png" alt="" width="100%">
