                    ...
                    <div class="sticky-content-inner">
                        ...
                        <div class="post--item post--single post--title-largest pd--30-0">
                            ...
                            <div class="post--info">
                                <ul class="nav meta">
                                    ...
                                    <li><a href="#"><i
                                                class="fa fm fa-comments-o"></i>{{ $tin->tintucComment->count() }}</a>
                                    </li>
                                </ul>
                            ...
                            <ul class="nav row">
                                @foreach ($ketiep as $ketiep)
                                    <li class="col-xs-6 ptop--30 pbottom--30">
                                        ...
                                        <div class="post--item">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $ketiep->slug]) }}"
                                                    class="thumb"><img
                                                        src="/uploads/tintuc/{{ $ketiep->hinhanh }}" alt=""></a>
                        ...
                        <div class="comment--list pd--30-0">
                            ...
                            <div class="post--items-title">
                                <h2 class="h4">{{ count($binhluan) }} bình luận</h2>
                                            ...
                                            <div class="comment--item clearfix">
                                                ...
                                                <div class="comment--info">
                                                    <div class="comment--header clearfix">
                                                        ...
                                                        <a href="{{ url('report' . $binhluan->id) }}"
                                                            class="reply"><i class="fa fa-flag"></i></a>
                                                    </div>
                                        ...
                                        @foreach ($xuhuong as $xuhuong)
                                            <li>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $xuhuong->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $xuhuong->hinhanh }}"
                                                                alt=""></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $xuhuong->slug]) }}"
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $luachon->slug]) }}"
                                                            class="thumb"><img
                                                                src="/uploads/tintuc/{{ $luachon->hinhanh }}"
                                                                alt=""></a>
