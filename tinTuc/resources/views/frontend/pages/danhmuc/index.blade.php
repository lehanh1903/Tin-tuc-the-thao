    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span><b>{{ $title->title }}</b></span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet', ['slug' => $tintuc->slug]) }}"
                                                    class="thumb"><img
                                                        src="/uploads/tintuc/{{ $tintuc->hinhanh }}" alt=""
                                                        width="281px" height="193px"></a>
                                                <a href="{{ url('properti/' . $tintuc->tintucProperti->slug) }}"
                                                    class="cat"><b>{{ $tintuc->tintucProperti->title }}</b></a>
                                            ...
                                            <div class="post--img">
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h2 class="h4"><a
                                                                href="{{ route('bai-viet', ['slug' => $tintuc->slug]) }}"
                                                                class="btn-link"><b>{{ $tintuc->title }}</b></a></h2>
                                                    </div>
                                                    <ul class="nav meta">
                                                        <li><a href="#"><i>{{ $tintuc->tintucUser->title }}</i></a></li>
                                                        <li><a href="#"><i>{{ $tintuc->ngayduyet }}</i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-single-v1.html"
                                                                        class="btn-link"><b>{{ $tintuc->title }}</b></a>
                                                                </h3>
                                                            </div>
                                                            <ul class="nav meta">
                                                                <li><a href="#"><i>{{ $tintuc->tintucUser->name }}</i></a></li>
                                                                <li><a href="#"><i>{{ $tintuc->ngayduyet }}</i></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <li class="col-md-12">
                                            ...
                                            <div class="post--item">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="post--img">
                                                            <a href="{{ route('bai-viet', ['slug' => $w4->slug]) }}"
                                                                class="thumb"><img
                                                                    src="/uploads/tintuc/{{ $w4->hinhanh }}"
                                                                    alt=""></a>
                                                            <a href="{{ url('properti/' . $w4->tintucProperti->slug) }}"
                                                                class="cat">{{ $w4->tintucProperti->title }}</a>
                                                            <a href="#" class="icon"><i
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a
                                                                        href="{{ route('bai-viet', ['slug' => $w4->slug]) }}"
                                                                        class="btn-link"><b>{{ $w4->title }}</b></a>
                                                                </h3>
                                                            </div>
                                                             <ul class="nav meta">
                                                                <li><a href="#"><i>{{ $w4->tintucUser->name }}</i></a></li>
                                                                <li><a href="#"><i>{{ $w4->ngayduyet }}</i></a></li>
                                                            </ul>
                                                        </div>
                        ...
                        @foreach ($w10 as $w10)
                            <li class="col-md-8">
                                ...
                                <div class="post--item post--layout-1 post--type-video post--title-large">
                                    <div class="post--img">
                                        <a href="{{ $w10->video }}" class="thumb"><img
                                                src="/uploads/tintuc/{{ $w10->hinhanh }}" alt=""></a>
                                        <a href="{{ url('properti/' . $w10->tintucProperti->slug) }}"
                                            class="cat">{{ $w10->tintucProperti->title }}</a>
                                        <a href="#" class="icon"><i class="fa fa-eye"></i></a>

                                        <div class="post--info">
                                            <ul class="nav meta">
                                                <li><a href="#"><i>{{ $w10->tintucUser->name }}</i></a></li>
                                                <li><a href="#"><i>{{ $w10->ngayduyet }}</i></a></li>
                                            </ul>

                                            <div class="title">
                                                <h2 class="h4"><a
                                                        href="{{ route('bai-viet', ['slug' => $w10->slug]) }}"
                                                        class="btn-link">{{ $w10->title }}</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="post--img">
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a
                                                                href="{{ route('bai-viet', ['slug' => $tintuc->slug]) }}"
                                                                class="btn-link">{{ $tintuc->tomtat }}</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="post--info">
                                                                ...
                                                                <ul class="nav meta">
                                                                    <li><a href="#"><i>{{ $tintuc->tintucUser->name }}</i></a>
                                                                    </li>
                                                                    <li><a href="#"><i>{{ $tintuc->ngayduyet }}</i></a></li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="post--action">
                                                                <a
                                                                    href="{{ route('bai-viet', ['slug' => $tintuc->slug]) }}">Chi
                                                                    tiết.</a>
                                                            </div>
                                                        </div>
                                                    </div>
